...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.competition_id'
        db.add_column('competition_submission', 'competition_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Submission.score'
        db.add_column('competition_submission', 'score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.competition_id'
        db.delete_column('competition_submission', 'competition_id')

        # Deleting field 'Submission.score'
        db.delete_column('competition_submission', 'score')
    ...
    models = {
        ...
        'competition.submission': {
            ...
            'competition_id': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
