...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionTable'
        db.create_table('competition_competitiontable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('competition', ['CompetitionTable'])

        # Adding field 'Judge.competition_table'
        db.add_column('competition_judge', 'competition_table',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.CompetitionTable'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.competition_table'
        db.add_column('competition_category', 'competition_table',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.CompetitionTable'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.pull_order'
        db.add_column('competition_submission', 'pull_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompetitionTable'
        db.delete_table('competition_competitiontable')

        # Deleting field 'Judge.competition_table'
        db.delete_column('competition_judge', 'competition_table_id')

        # Deleting field 'Category.competition_table'
        db.delete_column('competition_category', 'competition_table_id')

        # Deleting field 'Submission.pull_order'
        db.delete_column('competition_submission', 'pull_order')
    ...
    models = {
        ...
        'competition.category': {
            ...
            'competition_table': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competition.CompetitionTable']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'competition.competitiontable': {
            'Meta': {'object_name': 'CompetitionTable'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'competition.submission': {
            ...
            'pull_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
