...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrewerProfile.phone_number'
        db.alter_column('competition_brewerprofile', 'phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'BrewerProfile.phone_number'
        db.alter_column('competition_brewerprofile', 'phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(default='', max_length=20))
