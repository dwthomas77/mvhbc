...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrewerProfile.club'
        db.add_column('competition_brewerprofile', 'club',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Submission.competition_id'
        db.alter_column('competition_submission', 'competition_id', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'BrewerProfile.club'
        db.delete_column('competition_brewerprofile', 'club')


        # Changing field 'Submission.competition_id'
        db.alter_column('competition_submission', 'competition_id', self.gf('django.db.models.fields.IntegerField')())
